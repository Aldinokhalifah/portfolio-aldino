...
export const skills: SkillGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Model Context Protocol (MCP)", icon: "https://cdn.simpleicons.org/modelcontextprotocol" },
        ],
    },
]

export const certifications = [
    { name: "Software Engineer", issuer: "HackerRank", year: "2026", color: "bg-teal-50 text-teal-700 border border-teal-100" },
    { name: "Java Basic", issuer: "HackerRank", year: "2026", color: "bg-teal-50 text-teal-700 border border-teal-100" },
