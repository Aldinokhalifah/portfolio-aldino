...
export const experiences: Experience[] = [
    {
        ...
        description: "Building AssetFlow, a fullstack MVP for company asset management covering multi-branch operations, real-time monitoring, and role-based access control.",
        bullets: [
            "Developed AssetFlow — a fullstack asset management system with Next.js & Express.js",
            "Designed and integrated 30+ REST API endpoints with PostgreSQL database",
            "Built dynamic form rendering based on JSON schema templates per division",
            "Implemented role-based access control (RBAC) with branch-level permissions",
            "Created interactive dashboard with KPI cards, stacked bar charts, and audit logs using Recharts",
            "Tested all endpoints with Postman covering status codes, data validation, and edge cases",
        ],
        tags: ["Next.js", "Express.js", "PostgreSQL", "TanStack Query", "Postman", "GitHub"],
        featured: true,
    },
    // {
