        ...
        <section id="experience" className="py-20 bg-[#F5F5F0] px-4">
            <div className="max-w-5xl mx-auto">
                ...
                {isSingle && (
                    <>
                        {experiences.map((exp) => (
                            <motion.div key={exp.role + exp.company} {...fadeUp(0.1)}
                                className="flex flex-col md:grid md:grid-cols-12 gap-3">

                                {/* Main Card — dark, full detail */}
                                <div className="md:col-span-8 rounded-3xl bg-[#1A1A1A] p-8 flex flex-col gap-5">
                                    {/* Top */}
                                    ...
                                    {/* Role & Company */}
                                    <div>
                                        <h3 className="text-white font-bold text-2xl leading-snug mb-1">{exp.role}</h3>
                                        <p className="text-white/50 text-base font-medium">{exp.company}</p>
                                    </div>
                                ...
                                {/* Right col: 2 stat cards stacked */}
                                <div className="md:col-span-4 flex flex-col gap-3">
                                    ...
                                    {/* Stats card */}
                                    <div className="rounded-3xl bg-white border border-gray-100 p-6 flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-3 md:hidden">
                            {experiences.map((exp, i) => (
                                <motion.div key={exp.role + exp.company} {...fadeUp(0.1 + i * 0.07)}
                                    ...
                                    <div>
                                        <h3 className={`font-bold text-base leading-snug mb-0.5 ${exp.featured ? "text-white" : "text-[#1A1A1A]"}`}>{exp.role}</h3>
                                        <p className={`text-sm font-medium ${exp.featured ? "text-white/60" : "text-gray-500"}`}>{exp.company}</p>
                                    </div>
                                    ...
                                    <p className={`text-xs leading-relaxed ${exp.featured ? "text-white/60" : "text-gray-500"}`}>{exp.description}</p>
